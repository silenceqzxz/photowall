                           ...
                           '<header class="mod-hd">',
                               ...
                               '<a href="/profile/#{user_id}" class="avatar">',
                                ...
                                '<div class="profile-info">',
                                    '<a title="用户名" href="/profile/#{user_id}">#{username}</a>',
                                '</div>',
                            '</header>',
                            '<div class="mod-bd">',
                                '<div class="img-box">',
                                    '<a href="/image/#{id}" >',
                                        '<img src="#{url}?imageView/1/w/500/h/500">',
                                    '</a>',
                                '</div>',
                            '</div>',
                            '<div class="mod-ft">',
                                '<ul class="discuss-list js-discuss-list">',
                                    ...
                                    '<li>',
                                        ...
                                        '<a class="_4zhc5 _iqaka" title="#{comments[1].username}" href="/profile/#{comments[1].user_id}" data-reactid=".0.1.0.0.0.2.1.2:$comment-17856951190001917.1">#{comments[1].username}</a>',
                                        '<span>',
                                ...
                                '</ul>',
                                 '<section class="discuss-edit">',
                                    ...
                                    '</form>',
                                    '<button class="more-info" id="jsSubmit">提交评论</button>',
                                '</section>',
                            '</div>',
                        '</article>'].join(''), oImage);
                });
